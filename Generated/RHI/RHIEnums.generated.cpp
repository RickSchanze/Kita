...
Builder.Register();
}void Z_Reflection_Register_Func_Enum_ERHIColorSpace() {TypeBuilder Builder{};Builder.CreateType<ERHIColorSpace>("ERHIColorSpace");
Builder.AddField("sRGB", ERHIColorSpace::sRGB);
Builder.AddField("HDR10", ERHIColorSpace::HDR10);
Builder.AddField("Count", ERHIColorSpace::Count);
Builder.Register();
