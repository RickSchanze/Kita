...
#include "Engine/Editor/Windows/LoggingWindow.h"
...
const Type* MenuAction_OpenLoggingWindow::GetType() { return TypeOf<MenuAction_OpenLoggingWindow>(); }
void MenuAction_OpenLoggingWindow::WriteArchive(OutputArchive& Archive) const { 
Super::WriteArchive(Archive); 
} 
void MenuAction_OpenLoggingWindow::ReadArchive(InputArchive& Archive) { 
Super::ReadArchive(Archive); 
} 
