...
RHIPipeline_Vulkan::RHIPipeline_Vulkan(const RHIGraphicsPipelineDesc& Desc) {
  ...
  Array<VkPipelineColorBlendAttachmentState> ColorBlendAttachments = Desc.ColorBlend.Attachments | Ranges::Views::Transform([](const RHIPipelineColorBlendAttachmentDesc& BlendDesc) {
